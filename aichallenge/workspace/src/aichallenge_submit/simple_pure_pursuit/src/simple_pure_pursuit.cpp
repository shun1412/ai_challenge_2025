...
void SimplePurePursuit::onTimer()
{
  ...
  // Smooth steering angle to suppress rapid changes
  if (is_prev_steering_initialized_) {
    cmd.lateral.steering_tire_angle = steering_angle_smoothing_gain_ * prev_steering_angle_ +
      (1.0 - steering_angle_smoothing_gain_) * cmd.lateral.steering_tire_angle;
  } else {
    is_prev_steering_initialized_ = true;
  }
  prev_steering_angle_ = cmd.lateral.steering_tire_angle;
